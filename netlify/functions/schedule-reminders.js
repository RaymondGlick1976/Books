        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px;">
          ...
          <tr>
            <td style="background-color: #ffffff; padding: 40px 30px;">
              ...
              <p style="color: #999; font-size: 13px; margin: 24px 0 0 0; text-align: center;">Need to make changes? <a href="${manageUrl}" style="color: #667eea; text-decoration: none;">Reschedule or Cancel</a></p>
            </td>
          </tr>
          <!-- Footer -->
          <tr>
